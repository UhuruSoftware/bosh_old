...
ruby /var/vcap/packages/nagios_dashboard/nagios_dashboard/bin/generate_nagios_config.rb >>$LOG_DIR/generate_nagios_config.stdout.log 2>>$LOG_DIR/generate_nagios_config.stderr.log
