<?php
##
## Program: pnp4nagios-0.6.19 , Performance Data Addon for Nagios(r)
## License: GPL
...
#
$conf['rrdtool'] = "/var/vcap/packages/nagios/bin/rrdtool";
#
...
#
$conf['rrdbase'] = "/var/vcap/store/nagios/perfdata/";
#
# Location of "page" configs
#
$conf['page_dir'] = "/var/vcap/packages/nagios/pnp4nagios/etc/pages/";
#
...
#
$conf['background_pdf'] = '/var/vcap/packages/nagios/pnp4nagios/etc/background.pdf' ;
...
# /var/vcap/data/packages/nagios/0.1-dev.1/pnp4nagios/share/templates.dist is always the last directory to be searched for templates
#
# Add your own template directories here
# First match wins!
#$conf['template_dirs'][] = '/usr/local/check_mk/pnp-templates';
$conf['template_dirs'][] = '/var/vcap/packages/nagios/pnp4nagios/share/templates';
$conf['template_dirs'][] = '/var/vcap/packages/nagios/pnp4nagios/share/templates.dist';

#
# Directory to search for special templates
#
$conf['special_template_dir'] = '/var/vcap/packages/nagios/pnp4nagios/share/templates.special';
